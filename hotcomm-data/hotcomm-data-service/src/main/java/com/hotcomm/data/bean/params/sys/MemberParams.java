...
@NoArgsConstructor
public class MemberParams implements ParamsValidate {
	...
	@FieldValidate(limit = "1,10", type = ParamType.NUMBER)
	...
	public MemberParams(String password, String memberName) {
		super();
