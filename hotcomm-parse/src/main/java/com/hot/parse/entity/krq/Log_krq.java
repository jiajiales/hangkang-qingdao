package com.hot.parse.entity.krq;
...
@NoArgsConstructor
@Table(name = "log_krq")
public class Log_krq implements Serializable {
	/**
	* 
	*/
	...
	@Column(name = "fraflag")
	public boolean fraflag;

	@Column(name = "mofaflag")
	public boolean mofaflag;

	@Column(name = "soaflag")
	public boolean soaflag;
