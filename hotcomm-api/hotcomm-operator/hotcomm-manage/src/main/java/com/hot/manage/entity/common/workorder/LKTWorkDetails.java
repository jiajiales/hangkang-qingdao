...
public class LKTWorkDetails {
	...
	// (value = "工单关联的事件或者报警")
	private List<LKTWorkDetailsAllevent> allevents;

	// (value = "关联的设备")
	private LKTWorkDetailsDeviceAll devall;

	// (value = "事件或者报警关联的工作指示")
	private List<LKTWorkDetailsInstructions> instructions;
}
