...
public interface EventMapper extends Mapper<T_hk_event> {
	 ...
	 * @throws MyException
	 */
	List<AppEventList> getAppEventList(@Param("userid") Integer userid, @Param("moduleid") Integer moduleid,
			@Param("timeout") Integer timeout, @Param("message") String message) throws MyException;
	...
	Integer selectAppDeviceForDevnum(@Param("devnum") String devnum) throws MyException;
