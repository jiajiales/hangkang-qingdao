package com.hotcomm.prevention.service.manage.event;
...
import com.hotcomm.prevention.bean.mysql.manage.alarm.T_hk_event;
...
import com.hotcomm.prevention.bean.mysql.manage.event.AppEventInfo;
...
import com.hotcomm.prevention.bean.mysql.manage.event.T_hk_evdevrelation;
import com.hotcomm.prevention.bean.mysql.manage.event.T_module;
...
import com.hotcomm.prevention.db.mysql.manage.event.EventDevRelationMapper;
...
import com.hotcomm.prevention.db.mysql.manage.event.EventStateMapper;
...
public class EventServiceImpl implements EventService {
	...
	public Integer insertOneEvent(Integer userid, EventParam eventParam, Integer moduleid) throws MyException {
		...
		if (eventMapper.selectAppDeviceForDevnum(eventParam.getDevnum()) != moduleid) {
	...
	@Override
	public List<AppEventList> selectAppEventList(Integer userid, Integer moduleid, Integer timeout, String message)
			throws MyException {

		return eventMapper.getAppEventList(userid, moduleid, timeout, message);
	...
	public AlarmDev selectDevForUser(Integer deviceid, Integer moduleid) throws MyException {
		...
		return eventMapper.selectDevForUser(deviceid, moduleid);
	}
